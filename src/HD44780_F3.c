...
#define HD44780_DISP_dataLengthGTH			  16
...
#ifdef _NEW_PORTMAP_
#define HD44780_DATAPORTA							GPIOA	  // JIKOO
#endif
...
#ifndef _NEW_PORTMAP_
#define HD44780_DATABIT6							GPIO_PIN_6
#define HD44780_DATABIT7							GPIO_PIN_7
#else
#define HD44780_DATABIT6							GPIO_PIN_10 /* PB6 -> PA10 */ // JIKOO
#define HD44780_DATABIT7							GPIO_PIN_9  /* PB7 -> PA9  */ // JIKOO
#endif
...
#define hd44780_EN_high_delay()     	HAL_Delay(5) 	//(spec'd as 450ns from datasheet.)
...
#else // JIKOO
	if (data & 0x40) {
		GPIO_SetBits( HD44780_DATAPORTA, HD44780_DATABIT6);
	} else {
		GPIO_ResetBits( HD44780_DATAPORTA, HD44780_DATABIT6);
	}
	if (data & 0x80) {
		GPIO_SetBits( HD44780_DATAPORTA, HD44780_DATABIT7);
	} else {
		GPIO_ResetBits( HD44780_DATAPORTA, HD44780_DATABIT7);
	}
#endif
...
void HD44780_Init(void) {
	...
	/* Configure the HD44780 Data lines (PB4, PB5, PA10, PA9) as outputs*/
  GPIO_InitStructure.Pin = HD44780_DATABIT4 | HD44780_DATABIT5;
	GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStructure.Pull = GPIO_PULLUP;
	GPIO_InitStructure.Speed = GPIO_SPEED_HIGH;
  ...
  GPIO_InitStructure.Pin = HD44780_DATABIT6 | HD44780_DATABIT7;
	GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStructure.Pull = GPIO_PULLUP;
	GPIO_InitStructure.Speed = GPIO_SPEED_HIGH;

	HAL_GPIO_Init(HD44780_DATAPORTA, &GPIO_InitStructure);
...
/*********************************************************************************************
 ...
 Parameters			: x				-	column position (0 - HD44780_DISP_dataLengthGTH-1)
...
void HD44780_GotoXY(unsigned char x, unsigned char y) {
	...
	if (x > (HD44780_DISP_dataLengthGTH - 1))
		x = 0;
